...
const { getVsixName, buildHTTPOpts, buildVsixUrl } = require('../utils/circleci');
...
describe('Circleci util', () => {
    ...
    test('Should return a valid vsix name', () => {
        const data = { path: 'home/circleci/project/extensions/some-vscode-extension-1.2.14.vsix',
    ...
    test('Should return a valid vsix url', () => {
        const data = { path: 'home/circleci/project/extensions/some-vscode-extension-1.2.14.vsix',
        pretty_path: 'home/circleci/project/extensions/some-vscode-extension-1.2.14.vsix',
        node_index: 0,
        url: 'https://fake-gh.circle-artifacts.com/0/home/circleci/project/extensions/some-vscode-extension-1.2.14.vsix' };
        ...
        const outputData = {
            host: 'fake-gh.circle-artifacts.com',
            path: '/0/home/circleci/project/extensions/some-vscode-extension-1.2.14.vsix',
            method: 'GET'
        };

        expect(buildVsixUrl(data)).toEqual(outputData);
    });
